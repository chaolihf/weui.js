	        ...
	        options.onQueued = function (file) {
	            if (!onQueued.call(file)) {
	                ...
	                if (file.type.indexOf("image/") != -1) {
	                    ...
	                    var $fileName = $file.find('.ahui-uploader-filename');
...
/***/ (function(module, exports) {
	...
	module.exports = "<li class=\"weui-uploader__file weui-uploader__file_status\" data-id=\"<%= id %>\"> <div class=ahui-uploader-filename></div> <div class=weui-uploader__file-content> <i class=weui-loading style=width:30px;height:30px></i> </div> </li> ";
